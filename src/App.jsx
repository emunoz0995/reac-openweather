    ...
    <div className="App">
      <div className="card">
        ...
        <div className="temperature">
          <div className="items">
          <p><i className="fa-solid fa-up-long"></i>{isDegrees? climate.main?.temp_max : (climate.main?.temp_max * 9/5) + 32}°</p>
          <p><i className="fa-solid fa-down-long"></i>{isDegrees? climate.main?.temp_min : (climate.main?.temp_min * 9/5) + 32}°</p>
          </div>
          <h1>{isDegrees? climate.main?.temp: (climate.main?.temp * 9/5) + 32}°</h1>
        </div>
      </div>
